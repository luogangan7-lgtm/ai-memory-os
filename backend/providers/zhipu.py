...
class ZhipuProvider(BaseProvider):
    ...
    async def discover_models(self) -> list[ModelInfo]:
        return [
            ...
            ModelInfo(id="glm-4-plus", display_name="GLM-4 Plus", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=128000, pricing_per_1m_tokens=2.0),
            ...
            ModelInfo(id="glm-4-air", display_name="GLM-4 Air", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=128000, pricing_per_1m_tokens=1.0),
            ModelInfo(id="glm-4-long", display_name="GLM-4 Long", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=1000000, pricing_per_1m_tokens=1.0),
            ModelInfo(id="glm-5v-turbo", display_name="GLM-5V Turbo", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=128000, pricing_per_1m_tokens=1.0),
            ModelInfo(id="glm-4.7-flash", display_name="GLM-4.7 Flash (开源版/官方API不支持)", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=200000, pricing_per_1m_tokens=0.0),
            ModelInfo(id="glm-4-flash-250414", display_name="GLM-4 Flash 250414", provider="zhipu",
                      capabilities=[ModelCapability.CHAT], context_window=128000, pricing_per_1m_tokens=0.0),
