...
import { getAdminMemories, deleteAdminMemory, getTenants, AdminMemory } from '../api/endpoints';
...
export function MemoriesPage() {
  ...
  return (
    <div>
      <div className="page-title">记忆管理</div>
      <div className="page-sub">查看、检索和管理系统内的所有知识与多级记忆数据</div>
      ...
      <div className="card" style={{ padding: 18, marginBottom: 18 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }}>
          ...
          <div style={{ gridColumn: 'span 2' }}>
            <label style={{ fontSize: 11, color: 'var(--muted)', display: 'block', marginBottom: 4 }}>搜索内容/标题</label>
            <input
              placeholder="输入关键词搜索..."
              style={{
                width: '100%',
        ...
        {totalPages > 1 && (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 16, paddingTop: 12, borderTop: '1px solid var(--border)' }}>
            <span style={{ fontSize: 12, color: 'var(--muted)' }}>
              共 <strong>{total}</strong> 条记录 (第 {currentPage} / {totalPages} 页)
            </span>
