...
export const PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'qwen3.7-max', name: 'Qwen3.7 Max', type: 'chat', ctx: 128000, price: '¥2.5/M' },
      ...
      { id: 'text-embedding-v4', name: 'Text-Embedding-V4', type: 'embedding', recommended: true, ctx: 8192, price: '¥0.70/M', note: '1024d' },
      { id: 'text-embedding-v3', name: 'Text-Embedding-V3', type: 'embedding', ctx: 8192, price: '¥0.70/M', note: '1024d' },
      { id: 'text-embedding-v2', name: 'Text-Embedding-V2', type: 'embedding', ctx: 2048, price: '¥0.35/M', note: '1536d' },
      { id: 'text-embedding-v1', name: 'Text-Embedding-V1', type: 'embedding', ctx: 2048, price: '¥0.15/M', note: '1536d' },
      { id: 'text-embedding-async-v2', name: 'Text-Embedding Async V2', type: 'embedding', price: '¥0.35/M', note: '批量异步' },
      { id: 'gte-rerank', name: 'GTE-Rerank', type: 'rerank', recommended: true, price: '¥0.70/M', note: '4K ctx' },
      { id: 'qwen3-rerank', name: 'Qwen3-Rerank', type: 'rerank', price: '¥0.5/M', note: '8K ctx' },
    ],
  },
  {
    ...
    models: [
      ...
      { id: 'glm-5.1', name: 'GLM-5.1', type: 'chat', recommended: true, ctx: 128000, price: '¥1.0/M', note: '代码增强' },
      { id: 'glm-4-plus', name: 'GLM-4 Plus', type: 'chat', ctx: 128000, price: '¥2.0/M' },
      { id: 'glm-4-flash', name: 'GLM-4 Flash', type: 'chat', free: true, ctx: 128000, note: '官方推荐免费' },
      { id: 'glm-4-air', name: 'GLM-4 Air', type: 'chat', ctx: 128000, price: '¥1.0/M' },
      { id: 'glm-4-long', name: 'GLM-4 Long', type: 'chat', ctx: 1000000, price: '¥1.0/M', note: '1M 上下文' },
      { id: 'glm-5v-turbo', name: 'GLM-5V Turbo', type: 'vision', ctx: 128000, price: '¥1.0/M' },
      { id: 'glm-5-turbo', name: 'GLM-5 Turbo', type: 'chat', ctx: 128000, price: '¥0.5/M' },
      { id: 'glm-4.7-flash', name: 'GLM-4.7 Flash (开源版/官方API不支持)', type: 'chat', free: true, ctx: 200000, note: '不推荐在官方 API 使用' },
      { id: 'glm-4.7', name: 'GLM-4.7 (legacy)', type: 'chat', free: true, ctx: 128000, note: 'legacy id' },
  ...
  },
  {
    ...
    models: [
      { id: 'gpt-5.2', name: 'GPT-5.2', type: 'chat', recommended: true, ctx: 256000, price: '$5.0/$15/M', note: '最新旗舰' },
      { id: 'gpt-5.2-pro', name: 'GPT-5.2 Pro', type: 'chat', ctx: 256000, price: '$10.0/$30/M' },
      { id: 'gpt-4.1', name: 'GPT-4.1', type: 'chat', ctx: 256000, price: '$2.0/$6/M' },
      { id: 'gpt-4.1-mini', name: 'GPT-4.1 Mini', type: 'chat', ctx: 128000, price: '$0.10/$0.4/M' },
      ...
      { id: 'o4-mini', name: 'O4 Mini', type: 'reasoning', recommended: true, ctx: 200000, price: '$1.1/M' },
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash-Lite', type: 'chat', ctx: 1048576, price: '$0.075/$0.3/M' },
  ...
  },
  {
    ...
    features: ['Chat'],
    models: [
      { id: 'grok-4.3', name: 'Grok 4.3', type: 'chat', recommended: true, ctx: 1000000, price: '$5/$15/M' },
      { id: 'grok-4.3-mini', name: 'Grok 4.3 Mini', type: 'chat', ctx: 1000000, price: '$2/$8/M' },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ['Chat', 'Embedding'],
    models: [
      { id: 'doubao-seed-2-0-pro-260215', name: 'Doubao Seed 2.0 Pro', type: 'chat', recommended: true, ctx: 262144, price: '¥0.8/M', note: '旗舰最新' },
      { id: 'doubao-seed-2-0-lite-260215', name: 'Doubao Seed 2.0 Lite', type: 'chat', ctx: 262144, price: '¥0.3/M' },
      { id: 'doubao-1-5-pro-32k', name: 'Doubao 1.5 Pro', type: 'chat', ctx: 32768, price: '¥0.8/M' },
